...
_handle_dev_prop(int dev_slot, const char *dev, const char *prop, Device_Flags dev_flags)
{
   ...
   if (e_config->touch_extras)
     {
       if (!strcmp(prop, "Synaptics Middle Button Timeout"))
         {
            // 1 int - in ms
    ...
    ///////////////////////////////////////////////////////////////////////////
       // libinput devices
       else if (!strcmp(prop, "libinput Middle Emulation Enabled"))
         {
