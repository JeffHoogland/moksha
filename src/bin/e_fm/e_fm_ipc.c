...
static void
_e_fm_ipc_cb_list_result(void *data, Ecore_Thread *thread __UNUSED__, void *msg_data)
{
   E_Dir *ed = data;
...
static void
_e_fm_ipc_cb_list_end(void *data, Ecore_Thread *thread __UNUSED__)
{
   E_Dir *ed = data;
...
static void
_e_fm_ipc_cb_list_cancel(void *data, Ecore_Thread *thread __UNUSED__)
{
   E_Dir *ed = data;
   ed->lister_thread = NULL;
   eina_iterator_free(ed->lister_iterator);
