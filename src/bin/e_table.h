...
EAPI void         e_table_min_size_get      (Evas_Object *obj, Evas_Coord *minw, Evas_Coord *minh);
EAPI void         e_table_max_size_get      (Evas_Object *obj, Evas_Coord *maxw, Evas_Coord *maxh);
